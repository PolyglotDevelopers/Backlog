...
namespace Backlog.Data.Migrations
{
    ...
    [Migration("20240524073058_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backlog.Core.Domain.Masters.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backlog.Core.Domain.Masters.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backlog.Core.Domain.Employees.Employee", b =>
                {
                    ...
                    b.HasOne("Backlog.Core.Domain.Masters.Company", "Company")
                        .WithMany()
                    ...
                    b.HasOne("Backlog.Core.Domain.Masters.Currency", "Currency")
                        .WithMany()
