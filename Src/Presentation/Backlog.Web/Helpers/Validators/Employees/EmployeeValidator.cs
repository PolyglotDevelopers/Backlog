    ...
    public class EmployeeValidator : AbstractValidator<EmployeeModel>
    {
        public EmployeeValidator(ILocalizationService localizationService, IEmployeeService employeeService)
        {
            ...
            RuleFor(r => r.DateOfBirth)
                ...
                .GreaterThan(DateTime.MinValue).WithMessageAwait(localizationService.GetResourceAsync("EmployeeModel.DateOfBirth.InvalidMsg"));
            ...
            RuleFor(r => r.DateOfJoin)
                ...
                .GreaterThan(DateTime.Today.AddDays(-10)).WithMessageAwait(localizationService.GetResourceAsync("EmployeeModel.DateOfJoin.InvalidMsg"));
